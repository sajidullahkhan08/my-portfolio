...
export default function HomePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([configRes, projRes, blogRes, skillRes]) => {
        ...
        setHero(config.hero);
        setProfileImageUrl(config.profileImageUrl || "");
        setCvFileUrl(config.cvFileUrl || "");
  ...
  return (
    <main>
      <Helmet>
        <title>Sajidullah Khan — Full-Stack Developer</title>
      </Helmet>
        ...
        <div className="container hero-content-wrapper">
          ...
          >
            ...
            <h1 className="hero-title">
              {hero?.headline || "Building the Future with Code"}
            </h1>
          ...
          {profileImageUrl && (
            <motion.div
              className="hero-profile-desktop"
        ...
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-description">
              A selection of systems I've built with care and purpose.
            </p>
          </div>
          <div className="projects-grid">
            {projects.map((p, i) => (
              ...
              >
                ...
                <Link to={`/projects/${p._id}`} className="project-card-link">
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-description">
              Reflections on code, philosophy, and the questions that matter.
            </p>
          </div>
